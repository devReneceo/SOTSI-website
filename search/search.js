/* SOTSI whole-site search (Prototype Fase 2).
   Fuse.js over assets/data/search-index.json (pages + blog + episodes).
   URL-as-state (?q=), type filters, <mark> highlighting, boomer-readable cards.
   Base prefix + index URL come from data-attrs on [data-search-results], so this
   file is a near drop-in for the Webflow build (set data-base="/"). */
(function () {
  "use strict";
  ...
  var INDEX_URL =
    resultsEl.getAttribute("data-index") || BASE + "assets/data/search-index.json";
  var MAX_RESULTS = 80;
  var MIN_CHARS = 2;
